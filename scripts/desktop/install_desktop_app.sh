...
BACKEND_OPENAI_API_KEY="${STASH_OPENAI_API_KEY:-${OPENAI_API_KEY:-}}"
BACKEND_OPENAI_MODEL="${STASH_OPENAI_MODEL:-gpt-5-mini}"
BACKEND_OPENAI_BASE_URL="${STASH_OPENAI_BASE_URL:-https://api.openai.com/v1}"
BACKEND_OPENAI_TIMEOUT_SECONDS="${STASH_OPENAI_TIMEOUT_SECONDS:-60}"
...
STASH_OPENAI_API_KEY="$BACKEND_OPENAI_API_KEY"
STASH_OPENAI_MODEL="$BACKEND_OPENAI_MODEL"
STASH_OPENAI_BASE_URL="$BACKEND_OPENAI_BASE_URL"
STASH_OPENAI_TIMEOUT_SECONDS="$BACKEND_OPENAI_TIMEOUT_SECONDS"
EOF_CONF
...
export STASH_OPENAI_API_KEY
export STASH_OPENAI_MODEL
export STASH_OPENAI_BASE_URL
export STASH_OPENAI_TIMEOUT_SECONDS
