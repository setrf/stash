...
class PlannerSynthesisFallbackTests(unittest.TestCase):
    ...
    def test_synthesis_prefers_output_file_links_for_file_request(self) -> None:
        planner = Planner(Settings(codex_bin="definitely-not-installed"))
        result = planner.synthesize_response(
            user_message="create a summary txt file for my resume",
            planner_text="",
            project_summary={"root_path": "/tmp/demo"},
            tool_results=[
                {
                    ...
                    "exit_code": 0,
                    "cmd": "cat STASH_HISTORY.md",
                    "stdout": "This file is auto-generated by Stash backend.",
                    "stderr": "",
                }
            ],
            output_files=["resume_summary.txt"],
        )

        self.assertIsNotNone(result)
        self.assertIn("<stash_file>resume_summary.txt</stash_file>", result or "")
        self.assertNotIn("auto-generated by Stash backend", result or "")

    def test_synthesis_file_request_without_output_file_reports_missing_artifact(self) -> None:
        planner = Planner(Settings(codex_bin="definitely-not-installed"))
        result = planner.synthesize_response(
            user_message="create a summary txt file for my resume",
            planner_text="",
        ...
        self.assertIsNotNone(result)
        self.assertIn("could not detect a created output file", result or "")
        self.assertNotIn("auto-generated by Stash backend", result or "")
