...
class RuntimeConfig:
    ...
    direct_run_timeout_seconds: int = 30
    ...
    def from_settings(cls, settings: Settings) -> RuntimeConfig:
        return cls(
            ...
            direct_run_timeout_seconds=max(10, min(settings.direct_run_timeout_seconds, 300)),
...
class RuntimeConfigStore:
    ...
    def public_view(self) -> dict[str, Any]:
        ...
        return {
            ...
            "direct_run_timeout_seconds": cfg.direct_run_timeout_seconds,
    ...
    def update(
        ...
        *,
        ...
        direct_run_timeout_seconds: int | None = None,
        ...
        with self._lock:
            ...
            if direct_run_timeout_seconds is not None:
                if direct_run_timeout_seconds < 10 or direct_run_timeout_seconds > 300:
                    raise ValueError("direct_run_timeout_seconds must be between 10 and 300")
                next_cfg.direct_run_timeout_seconds = direct_run_timeout_seconds
    ...
    def _load_from_disk(self) -> None:
        ...
        try:
            self.update(
                ...
                direct_run_timeout_seconds=parsed.get("direct_run_timeout_seconds"),
