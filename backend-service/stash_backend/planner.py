    ...
    def _build_planner_prompt(
        ...
        *,
        ...
        return (
            ...
            "- Route naturally by intent: response-only when no file mutation is required, edit existing files when user asks to modify them, and create output files when user asks for a new artifact/export.\n"
            "- Prefer inline chat output for quick questions, explanations, and short answers.\n"
            "- Prefer in-place edits for existing text/csv/code files when the user asks to change existing content.\n"
            ...
            "- For office files (.docx/.xlsx/.pptx), do not overwrite source files in place; prefer companion outputs when edits are requested.\n"
